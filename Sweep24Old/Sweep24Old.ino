...
//  calibrate_samples();
  int elec_to_mux_custom[8] = {0, 1, 5, 12, 16, 7, 6, 2};
  ...
  elec_to_mux_custom[1] = 12;
  elec_to_mux_custom[2] = 13;
  elec_to_mux_custom[3] = 14;
  elec_to_mux_custom[4] = 18;
  elec_to_mux_custom[5] = 17;
  elec_to_mux_custom[6] = 16;
  elec_to_mux_custom[7] = 7;
  read_frame_custom(OP, AD, signal_rms, signal_mag, signal_phase, NUM_ELECTRODES, elec_to_mux_custom);
  read_frame_custom(AD, AD, signal_rms, signal_mag, signal_phase, NUM_ELECTRODES, elec_to_mux_custom);

  elec_to_mux_custom[0] = 9;
  elec_to_mux_custom[1] = 8;
  elec_to_mux_custom[2] = 7;
  elec_to_mux_custom[3] = 5;
  elec_to_mux_custom[4] = 12;
  ...
  elec_to_mux_custom[0] = 7;
  elec_to_mux_custom[1] = 5;
  elec_to_mux_custom[2] = 4;
  elec_to_mux_custom[3] = 3;
  elec_to_mux_custom[4] = 10;
  elec_to_mux_custom[5] = 11;
  elec_to_mux_custom[6] = 12;
  elec_to_mux_custom[7] = 16;
  read_frame_custom(OP, AD, signal_rms, signal_mag, signal_phase, NUM_ELECTRODES, elec_to_mux_custom);
  read_frame_custom(AD, AD, signal_rms, signal_mag, signal_phase, NUM_ELECTRODES, elec_to_mux_custom);

  elec_to_mux_custom[0] = 13;
  elec_to_mux_custom[1] = 14;
  elec_to_mux_custom[2] = 15;
  elec_to_mux_custom[3] = 21;
  elec_to_mux_custom[4] = 20;
  elec_to_mux_custom[5] = 19;
  elec_to_mux_custom[6] = 18;
  elec_to_mux_custom[7] = 17;
  read_frame_custom(OP, AD, signal_rms, signal_mag, signal_phase, NUM_ELECTRODES, elec_to_mux_custom);
  read_frame_custom(AD, AD, signal_rms, signal_mag, signal_phase, NUM_ELECTRODES, elec_to_mux_custom);
//  for(i = 0; i < 360; i++)
//  {       
