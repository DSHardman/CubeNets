...
//  calibrate_samples();
  int elec_to_mux_custom[8] = {21, 15, 14, 13, 17, 18, 19, 20};
  ...
  elec_to_mux_custom[0] = 14;
  elec_to_mux_custom[1] = 13;
  elec_to_mux_custom[2] = 12;
  elec_to_mux_custom[3] = 5;
  elec_to_mux_custom[4] = 7;
  elec_to_mux_custom[5] = 16;
  elec_to_mux_custom[6] = 17;
  elec_to_mux_custom[7] = 18;
  read_frame_custom(OP, AD, signal_rms, signal_mag, signal_phase, NUM_ELECTRODES, elec_to_mux_custom);
  read_frame_custom(AD, AD, signal_rms, signal_mag, signal_phase, NUM_ELECTRODES, elec_to_mux_custom);

  elec_to_mux_custom[0] = 12;
  elec_to_mux_custom[1] = 5;
  elec_to_mux_custom[2] = 1;
  elec_to_mux_custom[3] = 0;
  elec_to_mux_custom[4] = 2;
  elec_to_mux_custom[5] = 6;
  elec_to_mux_custom[6] = 7;
  elec_to_mux_custom[7] = 16;
  read_frame_custom(OP, AD, signal_rms, signal_mag, signal_phase, NUM_ELECTRODES, elec_to_mux_custom);
  read_frame_custom(AD, AD, signal_rms, signal_mag, signal_phase, NUM_ELECTRODES, elec_to_mux_custom);

  elec_to_mux_custom[0] = 3;
  elec_to_mux_custom[1] = 4;
  elec_to_mux_custom[2] = 5;
  elec_to_mux_custom[3] = 7;
  elec_to_mux_custom[4] = 16;
  elec_to_mux_custom[5] = 12;
  elec_to_mux_custom[6] = 11;
  elec_to_mux_custom[7] = 10;
  read_frame_custom(OP, AD, signal_rms, signal_mag, signal_phase, NUM_ELECTRODES, elec_to_mux_custom);
  read_frame_custom(AD, AD, signal_rms, signal_mag, signal_phase, NUM_ELECTRODES, elec_to_mux_custom);

  elec_to_mux_custom[0] = 5;
  elec_to_mux_custom[1] = 7;
  elec_to_mux_custom[2] = 8;
  elec_to_mux_custom[3] = 9;
  elec_to_mux_custom[4] = 23;
  elec_to_mux_custom[5] = 22;
  elec_to_mux_custom[6] = 16;
  elec_to_mux_custom[7] = 12;
  read_frame_custom(OP, AD, signal_rms, signal_mag, signal_phase, NUM_ELECTRODES, elec_to_mux_custom);
  read_frame_custom(AD, AD, signal_rms, signal_mag, signal_phase, NUM_ELECTRODES, elec_to_mux_custom);
//  for(i = 0; i < 360; i++)
//  {       
