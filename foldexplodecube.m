function foldexplodecube(responseobject, response)
    ...
    scatter3(zeros(size(sides(1).positions(:,1))), sides(1).positions(:,2)./30, sides(1).positions(:,1)./30, 50, sides(1).responses(:, response), 'filled');

    scatter3((sides(2).positions(:,1)-30)./30, sides(2).positions(:,2)./30, ones(size(sides(2).positions(:,1))), 50, sides(2).responses(:, response), 'filled');

    scatter3(2*ones(size(sides(3).positions(:,1))), sides(3).positions(:,2)./30, (90-sides(3).positions(:,1))./30, 50, sides(3).responses(:, response), 'filled');

    scatter3((120-sides(4).positions(:,1))./30, sides(4).positions(:,2)./30, -1*ones(size(sides(4).positions(:,1))), 50, sides(4).responses(:, response), 'filled');

    scatter3((sides(5).positions(:,1)-30)./30, 2*ones(size(sides(5).positions(:,1))), (60-sides(5).positions(:,2))./30, 50, sides(5).responses(:, response), 'filled');

    scatter3((sides(6).positions(:,1)-30)./30, zeros(size(sides(6).positions(:,1))), (sides(6).positions(:,2)+30)./30, 50, sides(6).responses(:, response), 'filled');
    ...
    line([0 0], [1 1], [-1 0], 'Color', 'k', 'linestyle', ':');
    line([0 0], [0 0], [-1 0], 'Color', 'k', 'linestyle', ':');
    line([1 1], [1 1], [-1 0], 'Color', 'k', 'linestyle', ':');
    line([1 1], [0 0], [-1 0], 'Color', 'k', 'linestyle', ':');

    line([1 2], [0 0], [0 0], 'Color', 'k', 'linestyle', ':');
    line([1 2], [1 1], [0 0], 'Color', 'k', 'linestyle', ':');
    line([1 2], [0 0], [1 1], 'Color', 'k', 'linestyle', ':');
    line([1 2], [1 1], [1 1], 'Color', 'k', 'linestyle', ':');

    line([0 0], [1 2], [0 0], 'Color', 'k', 'linestyle', ':');
    line([0 0], [1 2], [1 1], 'Color', 'k', 'linestyle', ':');
    line([1 1], [1 2], [0 0], 'Color', 'k', 'linestyle', ':');
    line([1 1], [1 2], [1 1], 'Color', 'k', 'linestyle', ':');
