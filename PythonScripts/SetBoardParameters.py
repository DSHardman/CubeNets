...
def setup():
    ...
    # pin_mapping = [7, 5, 9, 17, 11, 19, 13, 21, 15, 23, 41, 45, 43, 53, 51, 55, 1, 37, 3, 39, 33, 47, 35, 49] # used in working flat videos
    pin_mapping = [18, 20, 16, 8, 14, 6, 12, 4, 10, 2, 41, 45, 43, 53, 51, 55, 24, 37, 22, 39, 33, 47, 35, 49]  # flipped connector 1 for folded
